<template>
    ...
    <div class="w-1/2 md:w-1/3 lg:w-64 fixed md:top-0 md:left-0 h-screen lg:block bg-gray-100 border-r z-30" :class="sideBarOpen ? '' : 'hidden'" id="main-nav">
          ...
          <div class="mb-4 px-4">
            ...
            <router-link :to="{name: 'AdminManagePost'}" class="sidebar-links">
              <i class="fa fa-newspaper fill-current mr-3"></i>
              <span class="text-gray-700">Manage Posts</span>
            </router-link>
            <router-link :to="{name: 'AdminInbox'}" class="sidebar-links">
              <i class="fa fa-inbox fill-current mr-3"></i>
              <span class="text-gray-700">Messages</span>
            </router-link>
            <router-link 
              :to="{name: 'AdminManageProjects'}"
              class="sidebar-links">
              <i class="fa fa-code fill-current mr-3"></i>
            ...
            <div class="w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer">
              <i class="fa fa-images fill-current mr-3"></i>
...
.sidebar-links {
  @apply w-full flex items-center text-blue-400 h-10 pl-4 hover:bg-gray-200 rounded-lg cursor-pointer;
}

.sidebar-links.router-link-active {
  @apply bg-gray-200;
}
</style>
