<template>
    <Loading class="py-16" v-if="isPageLoading"/>
        ...
        <nav class="text-sm font-semibold mb-3" aria-label="Breadcrumb">
          <ol class="list-none p-0 inline-flex">
            ...
            <li class="flex items-center">
              <a href="#" class="text-gray-500">Update Post</a>
            </li>
          </ol>
        </nav>
        <!-- breadcrumb end -->
                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="flex justify-between">
                            <div class="self-center">
                                <div :class="{'hidden': !isPageStatus('UPDATING') }">
                            ...
                            <div class="flex p-1">
                                ...
                                <button role="submit" class="p-3 bg-blue-500 text-white hover:bg-blue-400" required :disabled="isPageStatus('UPDATING')">Update</button>
                            </div>
                        </div>
                    </form>
                </div>
...
export default {
    ...
    setup() {
        ...
        const { setPageStatus, isPageLoading, isPageStatus } = usePageStateManager()
        const post = reactive({})
        ...
        onMounted(async() => {
            ...
            Object.assign(post, await getPost(route.params.id))
            post.tags = post.tags.join(', ')
            setPageStatus('SUCCESS')
        })

        return { isPageLoading, post, isPageStatus, submit }
    }
